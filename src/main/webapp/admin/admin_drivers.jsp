						...
						<div class="grid_12">
							<nav class="horizontal-nav full-width horizontalNav-notprocessed">
								<ul class="sf-menu">
									...
									<li class="current"><a href="admin_drivers.jsp">Drivers</a></li>
									<li><a href="admin_vehicle.jsp">Vehicle</a></li>
									<li><a href="admin_category.jsp">Category</a></li>
				...
				<div class="container_12">
					<div class="grid_7">
						...
						<div class="extra_wrapper">
							...
							<p>Want to know more about the free theme produced by TemplateMonster? Click this <span class="color1"><a href="#">Domain Name</a></span>.</p>
							One theme is not enough for you to make a choice? Browse the vast variety of <span class="color1"><a href="#">Domain Name</a></span> at TemplateMonster’s website.
						</div>
		...
		<table class="table table-striped">
		  <thead>
		    <tr class="table-dark">
		      ...
		      <th scope="col">Contact CNo</th>
		    </tr>
		  </thead>
		  <tbody>
		  	<tag:forEach var="users" items="${usersList}">
			    <tr>
			      <td>${users.userId}</td>
