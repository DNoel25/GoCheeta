					...
					<div class="container_12">
						<div class="grid_12">
							<nav class="horizontal-nav full-width horizontalNav-notprocessed">
								<ul class="sf-menu">
									<li class="current"><a href="admin_dashboard.jsp">Home</a></li>
				...
				<div class="grid_4">
					<div class="banner">
						<div class="maxheight">
							...
							We are giving an efficient ride to whome that need to be quick
				...
				<div class="grid_4">
					<div class="banner">
						<div class="maxheight">
							...
							We are giving at a best price for the customers
							<a href="#" class="fa fa-share-square"></a>
						</div>
					</div>
				</div>
				<div class="grid_4">
					<div class="banner">
						<div class="maxheight">
							...
							We are doing the package delivery too
							<a href="#" class="fa fa-share-square"></a>
						</div>
					</div>
				</div>
