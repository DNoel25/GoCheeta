						...
						<div class="grid_12">
							<nav class="horizontal-nav full-width horizontalNav-notprocessed">
								<ul class="sf-menu">
									...
									<li><a href="admin_vehicles.jsp">Vehicle</a></li>
									<li><a href="admin_category.jsp">Category</a></li>
									<li class="current"><a href="admin_bookingHistory.jsp">Booking History</a></li>
								</ul>
							</nav>
							<div class="clear"></div>
						</div>
				...
				<div class="container_12">
					...
					<div class="grid_5">
						...
						<div class="map">
							...
							<p>Don’t forget, 24/7 support is available for TemplateMonster’s <span class="color1"><a href="#">Domain Name</a></span> only. Free ones lack this privilege.</p>
							<p>Use <span class="color1"><a href="#">Domain Name</a></span> services if you need any help in customization of your freebie.</p>
							<address>
								<dl>
